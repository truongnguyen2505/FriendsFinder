...
class UserDefaults {
    ...
    companion object {
        private const val REFERRER_PREFS_NAME = "com.eyefire.tota"
    ...
    fun getSharedPreference(keyPref: String?, defaultValue: Any?): Any? {
     ...
     */
    fun setSharedPreference(keyPref: String?, valuePref: Any?) {
        try {
